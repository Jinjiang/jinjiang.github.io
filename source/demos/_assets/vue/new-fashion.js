...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = {
	    components: {
	      headlines: __webpack_require__(7),
	      category: __webpack_require__(11),
	      coupon: __webpack_require__(12),
	      goods: __webpack_require__(13),
	      resource: __webpack_require__(14),
	      scene: __webpack_require__(15),
	      match: __webpack_require__(16),
	      brand: __webpack_require__(17)
	    },
	    data: {
	      navBarHeight: 88,
	      cnt: 0,
	...
	module.exports.render = function() {with(this){return _h(_e('scroller',{staticClass:["content"]}),[_h(_e('refresh',{staticClass:["refresh"],staticStyle:{flexDirection:"row"},attrs:{"display":displayRefresh},on:{"refresh":handleRefresh}}),function(){return [_h(_e('loading-indicator')),_m(0)]}),(show0)?_h(_e('headlines',{attrs:{"ds":showData.header}})):void 0,(show0)?_h(_e('category',{attrs:{"ds":showData.category}})):void 0,(show1)?_h(_e('coupon',{attrs:{"ds":showData.coupon}})):void 0,(show1)?_h(_e('goods',{attrs:{"ds":showData.goods}})):void 0,(show1)?_h(_e('resource',{attrs:{"ds":showData.resource}})):void 0,(show1)?_h(_e('scene',{attrs:{"ds":showData.scene}})):void 0,(show2)?_h(_e('match',{attrs:{"ds":showData.match}})):void 0,(show2)?_h(_e('brand',{attrs:{"ds":showData.brand}})):void 0,_h(_e('loading',{staticClass:["loading"],attrs:{"display":displayLoading},on:{"loading":handleLoading}}),function(){return [_m(1)]})])}}
	module.exports.staticRenderFns = [function(){with(this){return _h(_e('text',{staticStyle:{marginLeft:"36px",color:"#eee"}}),[_t("下拉刷新...")])}},
	function() {with(this){return _h(_e('text',{staticStyle:{color:"#eee"}}),[_t("加载更多...")])}}]
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = {
	    components: {
	      link: __webpack_require__(8),
	      banners: __webpack_require__(9)
	    },
	    props: {
	      ds: {
	        default: function () {
	...
	module.exports.render = function() {with(this){return _h(_e('div',{staticClass:["container"]}),[_h(_e('image',{staticClass:["banner"],attrs:{"src":ds.topBanner}})),_h(_e('div',{staticClass:["rule-container"]}),[_h(_e('link',{staticStyle:{fontSize:"22px",color:"#ffffff",textAlign:"center"},attrs:{"href":ds.ruleLink},staticAttrs:{"text":"帮助"}}))]),_h(_e('div',{staticClass:["announce"]}),[_h(_e('image',{staticClass:["announce-hd"],attrs:{"src":ds.announceHdBanner}})),_h(_e('banners',{staticStyle:{marginLeft:"6",marginRight:"6"},attrs:{"ds":ds.bannerItems,"width":NUMBER_233,"height":NUMBER_172,"space":NUMBER_3},staticAttrs:{"direction":"row"}}))])])}}
...
/***/ function(module, exports) {
	...
	module.exports.render = function() {with(this){return _h(_e('text',{on:{"click":clickHandler}}),[(_s(text))])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = {
	    components: {
	      banner: __webpack_require__(10)
	    },
	    props: ['ds', 'width', 'height', 'space', 'direction']
	  };

	module.exports.render = function() {with(this){return _h(_e('div'),[(direction==='row')?_h(_e('div',{staticStyle:{flexDirection:"row"}}),[(ds)&&_l((ds),function(item,$index,i){return _h(_e('div',{style:{ width: width, height: height, marginLeft: (i % ds.length ? space : 0) }}),[_h(_e('banner',{attrs:{"width":width,"height":height,"src":item.img,"href":item.url}}))])})]):void 0,(direction==='column')?_h(_e('div'),[(ds)&&_l((ds),function(item,$index,i){return _h(_e('div',{style:{ width: width, height: height, marginTop: (i % ds.length ? space : 0) }}),[_h(_e('banner',{attrs:{"width":width,"height":height,"src":item.img,"href":item.url}}))])})]):void 0])}}
	delete module.exports.el
...
/***/ function(module, exports) {
	...
	module.exports.render = function() {with(this){return _h(_e('image',{style:{ width: width, height: height },attrs:{"src":src,"image-quality":quality},on:{"click":clickHandler}}))}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h(_e('div'),[(ds.floorTitle)?_h(_e('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}})):void 0,_h(_e('div',{staticClass:["item-container"]}),[(items)&&_l((items),function(item,$index,i){return _h(_e('div',{style:{ width: 750, paddingBottom: 14, backgroundColor: item.colour }}),[_h(_e('div'),[_h(_e('banner',{attrs:{"width":NUMBER_750,"height":NUMBER_237,"src":i % 2 === 0 ? item.leftBannerImg : item.rightBannerImg,"href":item.bannerUrl}}))]),_h(_e('div',{staticClass:["shop-list"]}),[(item.shopList)&&_l((item.shopList),function(shop,$index,$key){return _h(_e('div',{staticClass:["shop-img-container"]}),[_h(_e('banner',{attrs:{"width":NUMBER_186,"height":NUMBER_208,"src":shop.picUrl,"href":shop.shopUrl}}))])})])])})]),_h(_e('div',{staticClass:["sub-item-container"],style:{ height: Math.round(subItems.length / 3) * (241 + 3) }}),[(subItems)&&_l((subItems),function(item,$index,i){return _h(_e('div',{staticClass:["sub-item"],style:{top: getSubItemTop(i), left: getSubItemLeft(i) }}),[_h(_e('image',{staticClass:["sub-item-bg"],attrs:{"src":subItemBg}})),_h(_e('div',{staticClass:["sub-item-img"]}),[_h(_e('banner',{attrs:{"width":NUMBER_248,"height":NUMBER_155,"src":item.industryImg,"href":item.industryUrl}}))]),_h(_e('div',{staticClass:["sub-item-title"]}),[_h(_e('text',{staticClass:["industry-title"],attrs:{"href":item.industryUrl}}),[(_s(item.industryTitle))]),_h(_e('text',{staticClass:["industry-benefit"],attrs:{"href":item.industryUrl}}),[(_s(item.industryBenefit))])])])})])])}}
	delete module.exports.el
...
/***/ function(module, exports) {
	...
	module.exports.render = function() {with(this){return _h(_e('div'),[(ds.floorTitle)?_h(_e('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}})):void 0,_h(_e('div',{staticClass:["wrapper"]}),[_h(_e('image',{staticClass:["img"],attrs:{"src":currentStatus}})),_h(_e('div',{staticClass:["my-coupon"],on:{"click":handleClick}})),_h(_e('div',{staticClass:["guides"],on:{"click":handleClick}})),_h(_e('div',{staticClass:["lottery"],on:{"click":handleClick}}))])])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return (!ds.isHide)?_h(_e('div'),[(ds.floorTitle)?_h(_e('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}})):void 0,_h(_e('slider',{staticClass:["slider"],staticAttrs:{"show-indicators":"true","auto-play":"true","interval":"3000"}}),[(ds.bannerItems)&&_l((ds.bannerItems),function(item,$index,$key){return _h(_e('div',{staticClass:["pannel"]}),[_h(_e('div'),[_h(_e('banner',{staticStyle:{marginBottom:"4"},attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img1,"href":item.url1}})),_h(_e('banner',{attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img2,"href":item.url2}}))]),_h(_e('div',{staticClass:["middle-col"]}),[_h(_e('banner',{attrs:{"width":NUMBER_240,"height":NUMBER_588,"src":item.img3,"href":item.url3}}))]),_h(_e('div'),[_h(_e('banner',{staticStyle:{marginBottom:"4"},attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img4,"href":item.url4}})),_h(_e('banner',{attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img5,"href":item.url5}}))])])}),_m(0)])]):void 0}}
	module.exports.staticRenderFns = [function(){with(this){return _h(_e('indicator',{staticStyle:{position:"absolute",width:"714",height:"200",left:"10",bottom:"-80",itemSize:"20",itemColor:"#999999",itemSelectedColor:"#000000"}}))}}]
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return (!ds.isHide)?_h(_e('div'),[_h(_e('div',{staticClass:["big-banner-container"]}),[_h(_e('banner',{attrs:{"width":NUMBER_750,"height":NUMBER_200,"src":ds.bigBannerImg,"href":ds.bigBannerUrl}}))]),_h(_e('banners',{attrs:{"ds":ds.smallBannerItems,"width":NUMBER_373,"height":NUMBER_224,"space":NUMBER_4},staticAttrs:{"direction":"row"}}))]):void 0}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h(_e('div'),[(ds.floorTitle)?_h(_e('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}})):void 0,_h(_e('div',{staticClass:["small-item-container"],style:{ height: Math.round(smallItems.length/2)*234 }}),[(smallItems)&&_l((smallItems),function(item,$index,i){return _h(_e('div',{staticClass:["small-item"],style:{ top: getItemTop(i), left: getItemLeft(i) }}),[_h(_e('div'),[_h(_e('image',{staticClass:["small-item-bg"],attrs:{"src":smallItemBg}}))]),_h(_e('div',{staticClass:["small-item-img"]}),[_h(_e('banner',{attrs:{"width":NUMBER_186,"height":NUMBER_206,"src":item.itemImg,"href":item.sceneUrl}}))]),_h(_e('div',{staticClass:["small-benifit-img"]}),[_h(_e('banner',{attrs:{"width":NUMBER_170,"height":NUMBER_100,"src":item.benefitImg,"href":item.sceneUrl}}))])])})])])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h(_e('div'),[(ds.floorTitle)?_h(_e('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}})):void 0,(ds.isShowTmSpecBanner && ds.tmSpecBanner)?_h(_e('div',{staticClass:["tm-banner"]}),[_h(_e('banner',{attrs:{"width":NUMBER_750,"height":NUMBER_200,"src":ds.tmSpecBanner.img,"href":ds.tmSpecBanner.url}}))]):void 0,(ds.bannerItems)&&_l((ds.bannerItems),function(item,$index,$key){return _h(_e('div',{style:{ flexDirection: 'row', marginBottom: NUMBER_4 }}),[_h(_e('div',{style:{ marginRight: NUMBER_4 }}),[_h(_e('banner',{attrs:{"width":NUMBER_373,"height":NUMBER_240,"src":item.leftImg,"href":item.leftUrl}}))]),_h(_e('div'),[_h(_e('banner',{attrs:{"width":NUMBER_373,"height":NUMBER_240,"src":item.rightImg,"href":item.rightUrl}}))])])})])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h(_e('div',{staticClass:["container"]}),[(ds.floorTitle)?_h(_e('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}})):void 0,_h(_e('div',{staticStyle:{marginLeft:"4",marginRight:"4"}}),[_h(_e('banners',{attrs:{"ds":bannerItems,"width":NUMBER_742,"height":NUMBER_230,"space":NUMBER_4},staticAttrs:{"direction":"column"}}))])])}}
	delete module.exports.el
